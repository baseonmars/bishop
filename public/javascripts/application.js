...
function textToChkBox(id, type) {
	var changes_c = document.getElementById( 'include-'+type+id );
	var changes_t = document.getElementById( type+'_text'+id );
	changes_c.checked = 'checked';
	changes_c.value  = changes_t.value
	return true;
}
